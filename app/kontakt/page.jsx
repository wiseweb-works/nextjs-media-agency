export default function Page() {
  return (
    <section className="h-full min-h-[calc(100dvh-124px)] bg-gradient-to-r dark:from-gray-700 dark:via-gray-800 dark:to-gray-900 ">
        ...
        <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
          <div className=" lg:w-1/2 lg:mx-6">
            ...
            <p className="max-w-xl mt-6">
              Stellen Sie uns alle Fragen – wir freuen uns auf Ihre Nachricht!
            </p>
            ...
            <div className="mt-6 space-y-8 md:mt-8">
              ...
              <p className="flex items-start -mx-2">
                ...
                <span className="mx-2 truncate w-72">+49 150 666 11 22</span>
              </p>
              ...
              <p className="flex items-start -mx-2">
                ...
                <span className="mx-2 truncate w-72">info@beispiel.de</span>
              </p>
            </div>

            <div className="mt-6 md:mt-8">
              <h3 className="">Folgen Sie uns</h3>
